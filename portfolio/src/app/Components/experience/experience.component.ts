  ...
  experiences = [
    {
      ...
      tags: ['Power Apps', 'Power Automate', 'Communication', 'Documentation']
    },
    {
      ...
      tags: ['Python', 'Robotics', 'IoT', 'Documentation', 'Powerpoint']
    },
    {
      ...
      tags: ['Unit Testing', 'Slack Communication', 'Python', 'Documentation']
    }
  ];
}
